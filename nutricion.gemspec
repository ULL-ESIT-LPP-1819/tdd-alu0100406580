...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Tabla nutricional}
  spec.description   = %q{Desarrollo Dirigido por Pruebas (TDD). Representación de un programa en Ruby para representar una Tabla Nutricional.}
